...
using Services.Locations.API.Infrastructure.Services;
...
namespace Locations.API.Controllers
{
    ...
    public class LocationsController : ControllerBase
    {
        ...
        [Route("")]
        [HttpGet]
        [ProducesResponseType(typeof(List<Services.Locations.API.Model.Locations>), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<List<Services.Locations.API.Model.Locations>>> GetAllLocationsAsync()
        {
        ...
        [Route("{locationId}")]
        [HttpGet]
        [ProducesResponseType(typeof(Services.Locations.API.Model.Locations), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<Services.Locations.API.Model.Locations>> GetLocationAsync(int locationId)
        {
